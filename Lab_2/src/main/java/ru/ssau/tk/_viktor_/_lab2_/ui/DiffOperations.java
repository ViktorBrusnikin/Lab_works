...
import ru.ssau.tk._viktor_._lab2_.ui.inputsomething.Editor;
...
public class DiffOperations extends JDialog {
    ...
    public DiffOperations(JFrame frame, TabulatedDifferentialOperator operationService) {
        ...
        firstFunctionPanel.setBorder(BorderFactory.createTitledBorder("Дифференцируемая функция"));
        ...
        JPanel operationPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(0, 0, new Color(0x718A71), 0, getHeight(), new Color(0x365536)); // Нижняя часть фона (более светлый серый)
        ...
        differentiateButton.setPreferredSize(new Dimension(200, 50));
    ...
    private JPanel createFunctionPanel(JTable table, ActionListener createListener, ActionListener loadListener, ActionListener saveListener) {
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(0, 0, new Color(0x819C6E), 0, getHeight(), new Color(0x365536));
                g2d.setPaint(gp);
                g2d.fillRect(0, 0, getWidth(), getHeight());
            }
        };
