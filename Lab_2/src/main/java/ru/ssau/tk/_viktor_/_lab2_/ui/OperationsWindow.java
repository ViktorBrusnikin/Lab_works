...
import ru.ssau.tk._viktor_._lab2_.io.FunctionsIO;
...
public class OperationsWindow extends JDialog {
    ...
    public OperationsWindow(JFrame frame, TabulatedFunctionOperationService operationService) {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(0, 0, new Color(0x718A71), 0, getHeight(), new Color(0x365536));
        ...
        // Размещение кнопок справа, а не снизу
        ...
        // Добавляем панель с функциями и панель с кнопками в основной layout
        add(functionsPanel, BorderLayout.CENTER);
        add(panel, BorderLayout.WEST);  // Изменено с SOUTH на EAST
    ...
    private JPanel createFunctionPanel(String title, JTable table, ActionListener createListener, ActionListener loadListener, ActionListener saveListener) {
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(100, 100, new Color(113, 138, 113), 0, getHeight(), new Color(54, 85, 54));
        ...
        panel.setBorder(BorderFactory.createTitledBorder(null, title, 0, 0, null, new Color(204, 219, 226)));
    ...
    private JPanel createResultPanel() {
        ...
        panel.setLayout(new BorderLayout());
        panel.setBorder(BorderFactory.createTitledBorder(null, "Результат", 0, 0, null, new Color(204, 219, 226)));
    ...
    private void createFunction(int operand){
        TabulatedFunctionFactory selectedFactory = operationService.FactoryGet();

        TabulatedFunction createdFunction = null;

        if (selectedFactory instanceof ArrayTabulatedFunctionFactory) {
            TableController arraysWindow = new TableController(owner, operationService.FactoryGet());
            ...
            MathController mathWindow = new MathController(owner, operationService.FactoryGet());
